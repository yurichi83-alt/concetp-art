...
이 폴더는 노효님의 배경 이미지 제작 프로젝트다. 기본 응답은 한국어. 현재 마스터 세트 v2.6 / 실행 v1.7 / 마스터03 본문 v2.2. 원본19장+승인 LDI5장+사용자 추가3장인 마스터27장과 기존 아트/세계관을 유지한다. A-01/A-02는 보조 선호 예시이며, B03-01~04는 별도 표면 표현 보조4장이다.
