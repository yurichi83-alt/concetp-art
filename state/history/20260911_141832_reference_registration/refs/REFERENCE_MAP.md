# Reference Map — 마스터 v2.5 · 참조 목록 2026-09-11-user-additions-01

원본 마스터 19장과 승인된 Little Devil Inside 보강 5장을 유지하고 사용자 추가 2장을 등록한 총 26장이다. A-01/A-02 선호 결과 2장과 검토 이력 3장은 별도이며 마스터를 대체하지 않는다.
...
실제 생성 입력 여부는 각 run의 `references.json`에 따로 기록한다. 마스터 등록이 매번 26장 모두를 이미지 도구에 전달한다는 뜻은 아니다. 아래 역할·제외 범위는 `refs/manifest.json`과 일치한다.

## 마스터 26장 — 원본 19장 + LDI 보강 5장 + 사용자 추가 2장
