# Reference Map — 마스터 v2.5 · 참조 목록 2026-09-11-user-additions-02
...
| M03-16 | [test_01.jpg](../refs/master03/test_01.jpg) | 건축의 큰 덩어리·실루엣, 넓은 색면, 따뜻한 전경과 차가운 배경의 색 관계, 빛·그림자 위계, 선택적 큰 손상과 재질 단순화. 높이·지붕 변주는 기존 직교 구조 안에서 해석 | 원본의 낮은 시점·원근·공간 배치, 중세/판타지 세계관, 대성당 높이, 인물·깃발·문자, 대각선 보행 경계 제외. 프로젝트 전체를 회화풍으로 전환하지 않음 |
| M03-17 | [test_02.jpg](../refs/master03/test_02.jpg) | 폭·높이·상층 후퇴에 따른 건축 덩어리와 실루엣의 변화, 다양한 지붕 윤곽, 창·발코니·외부 연결부의 선택적 디테일, 바랜 적색·청색·크림색의 큰 색면과 도장 박리, 넓은 명암으로 읽히는 재질 | 원본 카메라·원근·초고층 적층·과밀 배치·해안 도시 세계관·물/배/인물/식생의 자동 삽입 제외. 원통형 건물이나 회전된 건물의 보행 경계를 복사하지 않고 직교 건물 규칙 유지; 원통 형태는 허용된 비건물 탱크 등에 해석. 지붕 비움·높이·동선·구조 불일치의 근거로 사용하지 않음 |
