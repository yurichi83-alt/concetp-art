> 2026-09-11 정정: 아래는 생성 당시 계획 이력이다. Codex는 Images 2.5 제공 대상으로 발표되었으며, 이 출력의 실제 모델 버전은 도구 응답으로 확인되지 않았다. 내장2/2.5사용API필수라는 전제는 철회. 현재 판정은 MODEL_IDENTITY_CORRECTION.md 및 result.json을 따른다.
