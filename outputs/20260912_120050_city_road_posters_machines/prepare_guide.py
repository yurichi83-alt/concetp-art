...
# Exit-adjacent equipment outside protected lanes.
box(.25,8.05,1.1,1.15,0,1.6,machine)
box(15.15,.45,.65,1.15,0,1.8,machine)
...
box(5.55,6.2,1.25,2.0,0,1.35,machine)
...
d.text((70,75),'Preserve storeys. Add edge equipment / dumpster; both rear street lanes stay clear.',fill='#203943')
