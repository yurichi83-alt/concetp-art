...
# Roof A apparatus union 12.555 / 24.70 =50.83%. Varied utility silhouettes.
roof_devices=[
...
props=[('waste_compactor',(3.9,5.25,4.15,5.75,0,1.3)),('bin',(0.55,1.8,12,13.25,0,1.15)),('bags',(0.7,2,13.4,14.45,0,.7))]
for name,b in props:
...
# Corrected right_turn expands across the corner after removing right_bin.
routes[-1]['volume']=[11.3,15.4,5.5,7.7,0,2.5]
solids=[
