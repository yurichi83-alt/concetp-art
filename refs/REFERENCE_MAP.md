# Reference Map — 마스터 v2.6 · 참조 목록 2026-09-11-brush-support-01
...
| M03-16 | [test_01.jpg](../refs/master03/test_01.jpg) | 건축의 큰 덩어리·실루엣, 넓은 색면, 따뜻한 전경과 차가운 배경의 색 관계, 빛·그림자 위계, 선택적 큰 손상과 재질 단순화. 높이·지붕 변주는 기존 직교 구조 안에서 해석 | 원본의 낮은 시점·원근·공간 배치, 중세/판타지 세계관, 대성당 높이, 인물·깃발·문자, 대각선 보행 경계 제외. 전체 장면·구조·세계관 복사로 기존 기준을 대체하지 않으며 승인된 Master03의 큰 색면·평면 붓터치는 적용 |
